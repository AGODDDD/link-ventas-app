...
function PaymentBrandMark({ brand }: { brand: 'visa' | 'mastercard' | 'yape' | 'plin' | 'cash' }) {
  const marks = {
    ...
    yape: <svg viewBox="0 0 44 30" className="h-7 w-10" aria-hidden="true"><circle cx="29" cy="6" r="5" fill="#25D6C4" /><circle cx="29" cy="6" r="1.4" fill="#EAFBF8" /><text x="21" y="24" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="15" fontWeight="900" fontStyle="italic" letterSpacing="-1.8" fill="#6F3298">yape</text></svg>,
    plin: <svg viewBox="0 0 40 28" className="h-7 w-9" aria-hidden="true"><rect x="2" y="3" width="36" height="22" rx="11" fill="#18B6A7" /><text x="20" y="18" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="11" fontWeight="900" letterSpacing="-1.1" fill="#fff">plin</text></svg>,
