    ...
    <section aria-label="Información de confianza y medios de pago" className="rounded-2xl border border-neutral-200/80 bg-white px-5 py-3.5 shadow-[0_8px_24px_rgba(17,24,39,0.035)] sm:px-6">
      <div className="flex flex-col gap-4 2xl:flex-row 2xl:items-center 2xl:gap-7">
        ...
        <div className="flex shrink-0 items-center justify-center gap-4 border-t border-neutral-100 pt-3.5 sm:gap-5 2xl:border-l 2xl:border-t-0 2xl:pl-7 2xl:pt-0" aria-label="Medios de pago aceptados">
          ...
          <PaymentBrandMark brand="yape" />
          <PaymentBrandMark brand="plin" />
          <PaymentBrandMark brand="cash" />
        </div>
      </div>
    </section>
  )
...
function PaymentBrandMark({ brand }: { brand: 'visa' | 'mastercard' | 'yape' | 'plin' | 'cash' }) {
  const marks = {
    visa: <svg viewBox="0 0 60 26" className="h-6 w-11" aria-hidden="true"><path fill="#1A1F71" d="M4 4h8l-5 18H0L4 4Zm11 0h7.5c4.7 0 7.7 1.4 9.5 3.7l-4.7 4.3c-1.2-1.2-2.8-1.9-5.3-1.9-1.7 0-3 .5-3 1.4 0 .8 1.1 1.3 4 2.4 4.1 1.5 6 3.5 6 6.1 0 4.4-4.1 7-10.8 7-3.4 0-6.4-.8-8.3-2l2.3-5c1.7 1 4 1.7 6.4 1.7 1.8 0 3.2-.5 3.2-1.5 0-.8-1-1.3-3.8-2.3-4-1.4-6.1-3.5-6.1-6.3C10 6.8 12.2 4 15 4Zm22.2 0h7.2l4.3 18h-6.6l-.5-2.5h-7.2L33 22h-6.1L37.2 4ZM37 15.3h3.7L39.3 8 37 15.3Zm12.4-11.3H60l-1.7 18h-6.1l.8-12.4L47.2 22h-6.4l8.6-18Z" /></svg>,
    mastercard: <svg viewBox="0 0 42 26" className="h-6 w-10" aria-hidden="true"><circle cx="14" cy="13" r="10" fill="#EB001B" /><circle cx="28" cy="13" r="10" fill="#F79E1B" /><path d="M21 5.9a10 10 0 0 1 0 14.2 10 10 0 0 1 0-14.2Z" fill="#FF5F00" /></svg>,
    yape: <svg viewBox="0 0 42 30" className="h-7 w-9" aria-hidden="true"><circle cx="26" cy="6.5" r="5" fill="#25D6C4" /><circle cx="26" cy="6.5" r="1.6" fill="#EAFBF8" /><path d="M8.2 14.3c2.3 0 4.1 1.1 4.1 3.6 0 2.5-2.1 4.8-5.1 4.8H5.5l-.9 3.6H1l2.8-11.9h4.4Zm-1.6 3H6l-.5 2.2h.7c1.2 0 2-.6 2-1.4 0-.6-.5-.8-1.7-.8Zm7.1-3h3.5l-2.8 11.9h-3.5l2.8-11.9Zm5.8 0H23l-.6 2.6h1.9l-.7 2.9h-1.9l-.7 2.8c-.1.6.1.8.7.8.4 0 .9-.1 1.3-.2l-.6 2.6c-.7.3-1.5.4-2.3.4-2.2 0-3.3-1-2.8-3.1l1.1-4.8h-1.1l.7-2.9h1.1l.6-2.6Zm8.3 2.4c2.7 0 4.2 1.7 3.4 5.1-.8 3.2-3.3 5-6 5-1.7 0-2.8-.7-3.2-1.7l1.4-5.8c1-1.6 2.5-2.6 4.4-2.6Zm-.9 3c-1 0-1.8.8-2.1 2.1-.3 1.3.1 2.1 1.1 2.1s1.8-.8 2.1-2.1c.3-1.3-.1-2.1-1.1-2.1Z" fill="#6F3298" /></svg>,
    plin: <svg viewBox="0 0 38 28" className="h-7 w-9" aria-hidden="true"><circle cx="19" cy="14" r="12" fill="#18B6A7" /><path d="M11.6 10.2h3.2c2.3 0 3.7 1.1 3.7 3.2 0 2.2-1.6 3.6-4 3.6h-1.2v2.5h-1.7v-9.3Zm1.7 1.5v3.8h1.1c1.5 0 2.3-.7 2.3-1.9 0-1.2-.8-1.9-2.2-1.9h-1.2Zm6.5-2.3h1.7v10.1h-1.7V9.4Zm3.7.8c.6 0 1 .4 1 1s-.4 1-1 1-1-.4-1-1 .4-1 1-1Zm-.8 2.4h1.7v6.9h-1.7v-6.9Z" fill="#fff" /></svg>,
    cash: <svg viewBox="0 0 38 26" className="h-6 w-9" aria-hidden="true"><rect x="2" y="4" width="34" height="18" rx="4" fill="#E0ECDC" stroke="#9DBB9B" strokeWidth="1.5" /><rect x="7" y="8" width="24" height="10" rx="2" fill="#9FC49D" opacity=".42" /><circle cx="19" cy="13" r="3.2" fill="#77A276" /></svg>,
  }

  const labels = { visa: 'Visa', mastercard: 'Mastercard', yape: 'Yape', plin: 'Plin', cash: 'Efectivo' }
  return <span aria-label={labels[brand]} className="inline-flex shrink-0 items-center justify-center">{marks[brand]}</span>
}
