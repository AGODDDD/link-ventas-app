...
function PaymentBrandMark({ brand }: { brand: 'visa' | 'mastercard' | 'yape' | 'plin' | 'cash' }) {
  const marks = {
    ...
    yape: <span className="relative inline-flex h-7 w-10 items-end justify-center pb-0.5 font-[Arial,sans-serif] text-[15px] font-black italic leading-none tracking-[-0.12em] text-[#6F3298]"><i className="absolute right-0.5 top-0 h-2.5 w-2.5 rounded-full bg-[#25D6C4] shadow-[inset_0_0_0_2px_#EAFBF8]" />yape</span>,
    plin: <span className="inline-flex h-6 min-w-8 items-center justify-center rounded-full bg-[#12B6A5] px-1.5 font-[Arial,sans-serif] text-[10px] font-black lowercase leading-none tracking-[-0.08em] text-white">plin</span>,
