...
const TOUR_CONFIGS: Record<string, TourConfig> = {
  ...
  settings: {
    ...
    steps: [
      ...
      { eyebrow: 'Cuenta y privacidad', title: 'Mantén el control de tu cuenta', description: 'Consulta tu acceso y plan, actualiza tu nombre visible y encuentra tus controles de privacidad. El identificador técnico sirve únicamente para soporte.', target: '[data-tour="settings-account"]', settingsTab: 'general' },
