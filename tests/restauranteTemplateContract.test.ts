...
test('la interfaz restaurante deriva identidad y operación de la configuración de la tienda', async () => {
  ...
  assert.match(source, /w-\[290px\]/)
  assert.match(source, /md:ml-\[290px\]/)
  assert.match(source, /<main className="flex-1 md:ml-\[290px\]/)
  assert.doesNotMatch(source, /<main className="flex-1 w-full md:ml-\[290px\]/)
