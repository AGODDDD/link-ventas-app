        ...
        <div style={{
            ...
            <div style={{
                ...
                <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.45)', margin: '0 0 32px', lineHeight: '1.7' }}>
                    {trialExpired
                        ? <>Tu prueba Pro de 14 días ha concluido{nombre ? `, ${nombre}` : ''}. Activa el <strong style={{ color: '#a78bfa' }}>Plan Pro por S/ 29/mes</strong> para recuperar el acceso completo a todas las funciones avanzadas.</>
                        : <>{nombre ? `Hola ${nombre}, tu` : 'Tu'} cuenta <strong style={{ color: 'rgba(255,255,255,0.7)' }}>{email}</strong> fue creada correctamente. Escríbenos por WhatsApp y te activamos en minutos.</>
                    }
                </p>
                ...
                >
                    ...
                    {trialExpired ? 'Activar Plan Pro — S/ 29/mes' : 'Activar mi cuenta por WhatsApp'}
                </a>
