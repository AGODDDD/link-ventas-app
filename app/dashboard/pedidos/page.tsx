        ...
        <div className="space-y-6 pb-12 relative w-full">
                                    ...
                                    <div key={order.id} className={`bg-zinc-50 dark:bg-zinc-900 rounded-2xl border overflow-hidden shadow-xl ${isCompleted ? 'border-zinc-200 dark:border-zinc-800/50 opacity-60' : 'border-green-300/30'}`}>
                                        ...
                                        <div className="p-6 grid md:grid-cols-12 gap-6">
                                            ...
                                            <div className="md:col-span-4 space-y-4">
                                                <div>
                                                    <p className="text-[10px] font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-2">Cliente</p>
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-10 h-10 rounded-lg bg-green-50 flex items-center justify-center">
                                                            <User size={18} className="text-green-600" />
                                                        </div>
                                                        <div>
                                                            <p className="font-bold text-zinc-900 dark:text-zinc-100 text-sm">{order.customer_name || 'Sin nombre'}</p>
                                            ...
                                            {/* Items */}
                                            <div className="md:col-span-4 border-l-0 md:border-l border-t md:border-t-0 border-zinc-200 dark:border-zinc-800/50 pt-4 md:pt-0 md:pl-6">
                                                <p className="text-[10px] font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-3">Productos</p>
                                                <div className="space-y-2 max-h-[140px] overflow-y-auto pr-2 custom-scrollbar">
                                                    {items.map((item: any, idx: number) => {
                                                        ...
                                                        return (
                                                            <div key={idx} className="flex flex-col text-sm bg-white dark:bg-zinc-900 p-2 rounded-md gap-1">
                                                                <div className="flex justify-between items-start">
                                                                    <div className="flex items-start gap-2">
                                                                        ...
                                                                        <span className="font-medium text-zinc-500 dark:text-zinc-400 text-xs mt-0.5">{item.name}</span>
                                                                    </div>
                                                                    <span className="text-xs font-bold text-zinc-900 dark:text-zinc-100 whitespace-nowrap mt-0.5">S/ {(basePrice * item.quantity).toFixed(2)}</span>
                                                                </div>
                                                                {modsString && (
                                                                    <div className="flex justify-between text-[11px] text-zinc-500 dark:text-zinc-400 pl-9">
                                                                        <span className="truncate">- {modsString}</span>
                                                                    </div>
                                                                )}
                                                                {modsList.map((m: any, mIdx: number) => (
                                                                    <div key={mIdx} className="flex justify-between text-[11px] text-zinc-500 dark:text-zinc-400 pl-9">
                                            ...
                                            {/* Timeline + Action */}
                                            <div className="md:col-span-4 border-l-0 md:border-l border-t md:border-t-0 border-zinc-200 dark:border-zinc-800/50 pt-4 md:pt-0 md:pl-6 flex flex-col">
                                                <p className="text-[10px] font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-3">Estado del Pedido</p>
                                                ...
                                                <div className="flex-1 space-y-1.5 mb-4">
                                                    {DELIVERY_STATUSES.map((s, i) => (
                                                        <div key={s} className="flex items-center gap-2">
                                                            ...
                                                            <span className={`text-[11px] ${i <= statusIdx ? 'text-zinc-900 dark:text-zinc-100 font-medium' : 'text-zinc-500 dark:text-zinc-400/50'
                                                    ...
                                                    <>
                                                        ...
                                                        <div className="grid grid-cols-2 gap-2 mt-2">
                                                            ...
                                                            <button
                                                                ...
                                                                className="w-full flex items-center justify-center gap-1.5 px-3 py-2.5 bg-white dark:bg-zinc-900 hover:bg-white dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400 text-xs font-bold rounded-xl border border-zinc-200 dark:border-zinc-800/50 transition-all hover:scale-[1.02] active:scale-95 uppercase tracking-wider"
                                                            >
                        ...
                        {filteredStandard.length === 0 ? (
                            ...
                            <>
                                ...
                                <div key={order.id} className="bg-zinc-50 dark:bg-zinc-900 rounded-2xl border border-zinc-200/50 dark:border-zinc-800/50 shadow-2xl overflow-hidden group">
                                    ...
                                    {/* Order Header */}
                                    <div className="bg-zinc-50 dark:bg-[#131317] px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between border-b border-zinc-200/50 dark:border-zinc-800/50 gap-4">
                                    ...
                                    <div className="p-6 grid md:grid-cols-12 gap-6">
                                        ...
                                        <div className="md:col-span-5 space-y-4">
                                            <div>
                                                <p className="text-[10px] font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-1">Cliente</p>
                                                <div className="flex items-center gap-3">
                                                    <div className="w-10 h-10 rounded-lg bg-white dark:bg-zinc-800 flex items-center justify-center font-black text-zinc-900 dark:text-zinc-100 shadow-inner">
                                                        {order.customer_name ? order.customer_name.substring(0, 2).toUpperCase() : '👤'}
                                                    </div>
                                                    <div>
                                                        <p className="font-bold text-zinc-900 dark:text-zinc-100">{order.customer_name}</p>
                                        ...
                                        <div className="md:col-span-3 border-l-0 md:border-l border-t md:border-t-0 border-zinc-200 dark:border-zinc-800/50 pt-6 md:pt-0 md:pl-6 flex flex-col justify-center gap-3">

                                            {order.payment_proof_url && order.payment_proof_url !== 'CONTRA_ENTREGA' ? (
                                                <button
                                                    onClick={() => verComprobante(order.payment_proof_url)}
                                                    className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-white dark:bg-zinc-900 hover:bg-white dark:bg-zinc-800 text-primary text-sm font-bold rounded-xl border border-primary/20 transition-all hover:scale-[1.02] active:scale-95 shadow-[0_5px_15px_rgba(192,193,255,0.1)]"
                                                >
                                                    <Eye size={18} /> Ver Voucher
                                                </button>
                                            ) : (
                                                <div className="w-full text-center px-4 py-3 bg-white dark:bg-zinc-900 text-zinc-500 dark:text-zinc-400 text-xs font-bold rounded-xl border border-zinc-200 dark:border-zinc-800/50 uppercase tracking-widest">
                                                    Pago Contra Entrega
                                                </div>
                                            )}
                    ...
                    <>
                        {loadingLeads ? (
                            ...
                            <>
                                ...
                                <div key={lead.id} className="bg-zinc-50 dark:bg-zinc-900 rounded-2xl border-l-[6px] border-l-tertiary border-y border-r border-zinc-200/50 dark:border-zinc-800/50 shadow-2xl overflow-hidden flex flex-col md:flex-row">
                                    <div className="p-6 md:w-1/3 flex flex-col justify-center border-b md:border-b-0 md:border-r border-zinc-200 dark:border-zinc-800/50">
                                        <p className="text-[10px] uppercase font-bold text-zinc-500 dark:text-zinc-400 tracking-widest mb-2">Capturado el {new Date(lead.created_at).toLocaleString()}</p>
                                        <h3 className="font-headline font-black text-2xl text-zinc-900 dark:text-zinc-100 uppercase italic tracking-tight">{lead.name || 'Sin nombre'}</h3>
                                        <p className="text-tertiary font-bold mt-1">📞 {lead.phone || '-'}</p>
                                    </div>
                                    <div className="p-6 md:w-1/3 flex flex-col justify-center">
                                        <p className="text-[10px] uppercase font-bold text-zinc-500 dark:text-zinc-400 tracking-widest mb-1">Email / Origen</p>
                                        <p className="text-sm font-medium text-zinc-900 dark:text-zinc-100 truncate">{lead.email || 'Sin correo'}</p>
                                        <p className="text-[10px] font-bold text-primary mt-1 uppercase">{lead.preference || 'Lead Directo'}</p>
                                    </div>
                                    <div className="p-6 md:flex-1 flex flex-col justify-center items-center bg-white dark:bg-zinc-900">
            ...
            {(selectedProof || proofLoading) && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-background/90 backdrop-blur-md animate-in fade-in duration-200">
                    <div className="relative bg-surface rounded-2xl max-w-sm w-full overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.6)] border border-zinc-200 dark:border-zinc-800">
                        <button
                            onClick={() => { setSelectedProof(null); setProofLoading(false) }}
                            className="absolute top-4 right-4 p-2 bg-zinc-50 dark:bg-zinc-900 hover:bg-white dark:bg-zinc-800 rounded-full text-zinc-900 dark:text-zinc-100 z-10 transition-colors border border-white/10"
                        >
                            <X size={20} />
                        </button>
                        <div className="p-5 bg-zinc-50 dark:bg-[#131317] text-center font-bold tracking-widest text-zinc-900 dark:text-zinc-100 uppercase text-sm border-b border-zinc-200 dark:border-zinc-800/50">
            ...
            {shareOrder && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-background/90 backdrop-blur-md animate-in fade-in duration-200">
                    <div className="relative bg-surface rounded-2xl max-w-2xl w-full overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.6)] border border-zinc-200 dark:border-zinc-800 flex flex-col md:flex-row animate-in zoom-in-95 duration-200">
                        <button
                        ...
                        <div className="md:w-1/2 p-6 bg-zinc-50 dark:bg-[#131317] flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-zinc-200 dark:border-zinc-800/50">
                            <p className="text-[10px] uppercase font-bold text-zinc-500 dark:text-zinc-400 tracking-widest mb-4">Vista Previa Rápida</p>
