...
const features = [
  ...
  [<CreditCard key="card" size={24} />, 'Pasarela Culqi', 'Cobra con tarjetas y billeteras digitales de forma segura.', 'text-emerald-300 bg-emerald-400/10'],
